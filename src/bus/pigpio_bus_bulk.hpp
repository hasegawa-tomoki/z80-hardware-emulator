#ifndef Z80EMU_PIGPIOBUSBULK_HPP
#define Z80EMU_PIGPIOBUSBULK_HPP

#include <array>
#include <ctime>
#include "bus.hpp"

class PigpioBusBulk : public Bus {
public:
    PigpioBusBulk();
    ...
    static const uint8_t RPi_GPIO_DATA_BUS_OE = 26;
    ...
    static const uint8_t DATA_BUS_ISOLATED = 1;
    static const uint8_t DATA_BUS_ENABLED = 0;
};


#endif //Z80EMU_PIGPIOBUSBULK_HPP
